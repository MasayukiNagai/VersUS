...
def getVUS_Clinvar(idLists, genes):
    ...
    missense_info = Entrez.efetch(db='clinvar', id=idLists, rettype='vcv', is_variationid="true", from_esearch="true",
...
# def getVUS_Clinvar(xmlList):
#     data = {'Gene': [], 'VUS_protein': [], 'NP': [], 'PDB': []}
#     tree = ET.parse(xmlList)
#     root = tree.getroot()
#     for misseense in root.iter('ClinVarSet'):
